...
import { ArrowLeft, Edit, HelpCircle, ArrowRightLeft, Check, Trophy, Target, TrendingUp } from "lucide-react"
...
export default function MatchDetailsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"resumo" | "eventos" | "elenco">(
    "resumo"
  )
      ...
      <div className="px-6 py-6 max-w-4xl mx-auto">
        ...
        {activeTab === "elenco" && (
          <div className="flex flex-col items-center">
            ...
            <div className="bg-white rounded-lg border overflow-hidden w-full max-w-4xl">
